    ...
    $TreatedRepurchases = GetTreatedRepurchases($bdd);
    ?>
                ...
                <div class="card shadow">
                    <div class="card-body my-n2">
                        ...
                        <table class="table table-striped table-hover table-borderless">
                            ...
                            <tbody>
                                <?php foreach ($TreatedRepurchases  as  $TreatedRepurchase) { ?>
                                    <tr>
                                        <td><?= htmlspecialchars($TreatedRepurchase['id']) ?></td>
                                        <!-- <th scope="col"></th> -->
                                        <td><?= htmlspecialchars($TreatedRepurchase['type_loan']) ?></td>
                                        <td><?= htmlspecialchars($TreatedRepurchase['price']) ?></td>
                                        <td><?= htmlspecialchars($TreatedRepurchase['number_of_loans']) ?></td>
                                        <td>
