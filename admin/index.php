                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class=" dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                            <a class="dropdown-item" href="actions/modifier_statut_assurance.php?id=<?= $lastInsurance['id'] ?>&action=complétée">complétée</a>
                                            <a class="dropdown-item" href="actions/modifier_statut_assurance.php?id=<?= $lastInsurance['id'] ?>&action=en cours">en
                                                cours de traitement</a>
                                            <a class="dropdown-item" href="actions/modifier_statut_assurance.php?id=<?= $lastInsurance['id'] ?>&action=traitée">Traitée</a>
                                            <a class="dropdown-item" href="actions/modifier_statut_assurance.php?id=<?= $lastInsurance['id'] ?>&action=supprimer" id="supp">supprimer</a>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class=" dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                            <a class="dropdown-item" href="actions/modifier_statut_rachat.php?id=<?= $lastRepurchase['id'] ?>&action=complétée">complétée</a>
                                            <a class="dropdown-item" href="actions/modifier_statut_rachat.php?id=<?= $lastRepurchase['id'] ?>&action=en cours">en
                                                cours de traitement</a>
                                            <a class="dropdown-item" href="actions/modifier_statut_rachat.php?id=<?= $lastRepurchase['id'] ?>&action=traitée">Traitée</a>
                                            <a class="dropdown-item" href="actions/modifier_statut_rachat.php?id=<?= $lastRepurchase['id'] ?>&action=supprimer" id="supp">supprimer</a>
                                        </div>
                                    </div>
                                </td>
