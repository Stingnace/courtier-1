 <?php
    ...
    $TreatingRepurchases = GetTreatingRepurchases($bdd);
    ?>
 ...
 <main role="main" class="main-content">
     <div class="container-fluid">
         <div class="row justify-content-center">
             ...
             <!-- ***********************INFOS SUR LES DEMANDES DE RACHAT DE CREDIT********************************************* -->
             ...
             <div class="card shadow">
                 <div class="card-body my-n2">
                     ...
                     <table class="table table-striped table-hover table-borderless">
                         ...
                         <tbody>
                             <?php foreach ($TreatingRepurchases  as  $TreatingRepurchase) { ?>
                                 <tr>
                                     <td><?= htmlspecialchars($TreatingRepurchase['id']) ?></td>
                                     <!-- <th scope="col"></th> -->
                                     <td><?= htmlspecialchars($TreatingRepurchase['type_loan']) ?></td>
                                     <td><?= htmlspecialchars($TreatingRepurchase['price']) ?></td>
                                     <td><?= htmlspecialchars($TreatingRepurchase['number_of_loans']) ?></td>
                                     <td>
