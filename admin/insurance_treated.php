 <?php
    ...
    $TreatedInsurances = GetTreatedInsurances($bdd)
    ?>
         ...
         <div class="row justify-content-center">
             ...
             <div class="card shadow">
                 <div class="card-body my-n2">
                     <h2>Les demandes d'assurance traitées</h2>
                     <table class="table table-striped table-hover table-borderless">
                         ...
                         <tbody>
                             <?php foreach ($TreatedInsurances  as $TreatedInsurance) { ?>
                                 <tr>
                                     <td><?= htmlspecialchars($TreatedInsurance['id']) ?></td>
                                     <!-- <th scope="col"></th> -->
                                     <td><?= htmlspecialchars($TreatedInsurance['type_loan']) ?></td>
                                     <td><?= htmlspecialchars($TreatedInsurance['number_users']) ?></td>
                                     <td><?= htmlspecialchars($TreatedInsurance['research_status']) ?></td>
                                     <td><?= htmlspecialchars($TreatedInsurance['type_duration']) ?></td>
                                     <td><?= htmlspecialchars($TreatedInsurance['choice_bank']) ?></td>
