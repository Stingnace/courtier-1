...
$TreatedHomeLoans = GetTreatedHomeLoans($bdd);
?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="card shadow">
                <div class="card-body my-n2">
                    <h2>Les demandes de prêts immobiliers traitées</h2>
                    <table class="table table-striped table-hover table-borderless">
                        ...
                        <tbody>
                            <?php foreach ($TreatedHomeLoans as  $TreatedHomeLoan) { ?>
                                <tr>
                                    <td><?= $$TreatedHomeLoan['id'] ?></td>
                                    <!-- <th scope="col"></th> -->
                                    <td><?= htmlspecialchars($TreatedHomeLoan['nature_property']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['conditions']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['usages']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['search_situation']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['situation_current_home']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['location_future_property']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['value_property']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['value_works']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['loan_mode']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['personal_contribution']) ?></td>
                                    <td><?= htmlspecialchars($TreatedHomeLoan['choice_bank']) ?></td>
                                    <td>
