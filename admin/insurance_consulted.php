  <?php
    ...
    $ConsultedInsurances = GetConsultedInsurances($bdd);
    ?>
          ...
          <div class="row justify-content-center">
              ...
              <div class="card shadow">
                  <div class="card-body my-n2">
                      <h2>Les demandes d'assurance en cours </h2>
                      <table class="table table-striped table-hover table-borderless">
                          ...
                          <tbody>
                              <?php foreach ($ConsultedInsurances  as $ConsultedInsurance) { ?>
                              <tr>
                                  <td><?= htmlspecialchars($ConsultedInsurance['id']) ?></td>
                                  <!-- <th scope="col"></th> -->
                                  <td><?= htmlspecialchars($ConsultedInsurance['type_loan']) ?></td>
                                  <td><?= htmlspecialchars($ConsultedInsurance['number_users']) ?></td>
                                  <td><?= htmlspecialchars($ConsultedInsurance['research_status']) ?></td>
                                  <td><?= htmlspecialchars($ConsultedInsurance['type_duration']) ?></td>
                                  <td><?= htmlspecialchars($ConsultedInsurance['choice_bank']) ?></td>
