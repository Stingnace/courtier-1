...
$TreatingHomeLoans = GetTreatingHomeLoans($bdd)
?>
</aside>
        ...
        <div class="row justify-content-center">
            ...
            <div class="card shadow">
                <div class="card-body my-n2">
                    <h2>Les demandes de prêts immobiliers en cours</h2>
                    <table class="table table-striped table-hover table-borderless">
                        ...
                        <tbody>
                            <?php foreach ($TreatingHomeLoans as  $TreatingHomeLoan) { ?>
                                <tr>
                                    <td><?= $TreatingHomeLoan['id'] ?></td>
                                    <!-- <th scope="col"></th> -->
                                    <td><?= htmlspecialchars($TreatingHomeLoan['nature_property']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['conditions']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['usages']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['search_situation']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['situation_current_home']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['location_future_property']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['value_property']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['value_works']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['loan_mode']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['personal_contribution']) ?></td>
                                    <td><?= htmlspecialchars($TreatingHomeLoan['choice_bank']) ?></td>
                                    <td>
