 <?php
    ...
    $TreatingInsurances = GetTreatingInsurances($bdd)
    ?>
             ...
             <div class="card shadow">
                 <div class="card-body my-n2">
                     ...
                     <table class="table table-striped table-hover table-borderless">
                         ...
                         <tbody>
                             <?php foreach ($TreatingInsurances  as $TreatingInsurance) { ?>
                                 <tr>
                                     <td><?= htmlspecialchars($TreatingInsurance['id']) ?></td>
                                     <!-- <th scope="col"></th> -->
                                     <td><?= htmlspecialchars($TreatingInsurance['type_loan']) ?></td>
                                     <td><?= htmlspecialchars($TreatingInsurance['number_users']) ?></td>
                                     <td><?= htmlspecialchars($TreatingInsurance['research_status']) ?></td>
                                     <td><?= htmlspecialchars($TreatingInsurance['type_duration']) ?></td>
                                     <td><?= htmlspecialchars($TreatingInsurance['choice_bank']) ?></td>
