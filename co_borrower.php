        ...
        <form method="POST" action="./settings/form_back.php">
            <div class="js_speak_projet_js">
                    ...
                    <div class="radio-buttons">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select" name="situation_professional1" required="required" aria-label="Default select example">
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <select class="form-select" name="situation_contract1" required="required" aria-label="Default select example">
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input class="js_date" name="duration_contract1" type="date">
                            </div>
                ...
                <div class="main-container ">
                    <div class="radio-buttons">
                        <div class="js_logo_borrower">
                            <i class="bi bi-people"></i>CO-EMPRUNTEUR
                        </div>

                        <div class="mb-3">
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon3">Situation professionnelle</span>
                                <select class="form-select" name="situation_professional2" required="required" aria-label="Default select example">
                                    <option value="Employé">Employé</option>
                                    <option value="Ouvrier">Ouvrier</option>
                                    <option value="Cadre">Cadre</option>
                                    <option value="Fonctionnaire">Fonctionnaire</option>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon3">Contrat de travail</span>
                                <select class="form-select" name="situation_contract2" required="required" name="co_borrower" aria-label="Default select example">
                                    <option value="CDI">CDI</option>
                                    <option value="CDI (période d'essai)">CDI (période d'essai)</option>
                                    <option value="CDD">CDD</option>
                                    <option value="Intérim">Intérim</option>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon3">Vous occupez votre poste actuel depuis</span>
                                <input class="js_date" name="duration_contract2" type="date">
                            </div>
